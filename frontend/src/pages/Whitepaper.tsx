...
const SECTION_DEFINITIONS = [
  {
    key: 'problem',
    insertLabel: 'Paste section: 1. The Problem',
    title: '1. The Problem',
    body: (
      <>
        <p>
  ...
  {
    key: 'thesis',
    insertLabel: 'Paste section: 2. Our Thesis',
    title: '2. Our Thesis',
    body: (
      <>
        <p>
  ...
  {
    key: 'how',
    insertLabel: 'Paste section: 3. How Penny Works',
  ...
  {
    key: 'flow',
    insertLabel: 'Paste block: Payment Flow Comparison',
  ...
  {
    key: 'value',
    insertLabel: 'Paste section: 5. Why It Matters',
  ...
  {
    key: 'features',
    insertLabel: 'Paste section: 6. Key Features',
  ...
  {
    key: 'standards',
    insertLabel: 'Paste section: 7. Open Standards',
  ...
  {
    key: 'roadmap',
    insertLabel: 'Paste block: What’s Next',
    title: '8. What’s Next',
    body: (
      <ul>
...
function Whitepaper() {
  ...
  const revealSection = (key: SectionKey) => {
          ...
          <div className="editor-body">
            ...
            <div className="editor-content">
              ...
              <div className="editor-hint">
                ...
                <p>
                  Scroll to keep writing or click the floating + buttons to paste prepared sections.
                  Everything below is editable markdown.
                </p>
              </div>

              <section className="editor-block revealed" id="section-abstract">
                <div className="editor-card">
                  <div className="editor-card-label">Abstract</div>
                  {ABSTRACT_CONTENT}
                </div>
              </section>
              ...
              {SECTION_DEFINITIONS.map((section) => {
                ...
                return (
                  <section
                    ...
                    className={`editor-block ${isRevealed ? 'revealed' : ''}`}
                  >
                    {isRevealed ? (
                      <div className="editor-card">
                        <div className="editor-card-label">Inserted block</div>
                        <h3>{section.title}</h3>
                        {section.body}
                      </div>
                    ) : (
                      <button
                        ...
                        onClick={() => revealSection(section.key)}
                        aria-expanded={false}
                      >
              ...
              <section className="editor-block revealed">
                <div className="editor-card editor-card--cta">
                  <div className="editor-card-label">9. Join the Network</div>
                  <p>
                    Penny.io is the home for people who believe knowledge should travel at the speed
                    of a signature. If you’re a writer frustrated with legacy platforms or a reader
                    tired of hundred-dollar paywalls, we built this for you.
                  </p>
                  <ul>
